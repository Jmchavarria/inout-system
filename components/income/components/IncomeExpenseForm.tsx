...
export const IncomeExpenseForm: React.FC<IncomeExpenseFormProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!result.success) {
      ...
      setErrors(mapZodErrors<TransactionFormData>(result.error));
      return;
    }
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                disabled={isSubmitting}
                className={`w-full p-2 border rounded-lg focus:ring-2 focus:ring-gray-600 focus:border-transparent outline-none transition ${errors.amount ? 'border-red-500' : 'border-gray-300'
                  }`}
            ...
            <div>
              ...
              <input
                ...
                disabled={isSubmitting}
                className={`w-full p-2 border rounded-lg focus:ring-2 focus:ring-gray-600 focus:border-transparent outline-none transition ${errors.concept ? 'border-red-500' : 'border-gray-300'
                  }`}
