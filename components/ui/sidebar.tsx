...
export default function Sidebar() {
  ...
  const menuItems = [
    { href: "/income", label: "Income and expenses", icon: <CircleDollarSign size={20} /> },
    ...
    <div className="flex h-screen">
      ...
      >
        ...
        <div className="absolute bottom-6 left-4 right-4">
          <button className="flex items-center px-3 py-2 rounded-lg text-gray-600 hover:text-red-500 hover:bg-gray-100 w-full min-w-0">
            <div className={`flex items-center w-full min-w-0 ${isOpen ? "gap-3" : "gap-0"}`}>
              <div className="flex-shrink-0">
                <LogOut size={18} />
              </div>
              <span
